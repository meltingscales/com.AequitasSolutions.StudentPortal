...
public class SwitchRenderer extends ViewRenderer_2 implements IGCUserPeer, CompoundButton.OnCheckedChangeListener {
    ...
    public SwitchRenderer(Context context, AttributeSet attributeSet, int i) {
        ...
        if (getClass() == SwitchRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.SwitchRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i)});
        }
    }
    ...
    public SwitchRenderer(Context context, AttributeSet attributeSet) {
        ...
        if (getClass() == SwitchRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.SwitchRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[]{context, attributeSet});
        }
    }
    ...
    public SwitchRenderer(Context context) {
        super(context);
        if (getClass() == SwitchRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.SwitchRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
