...
public class PlatformRenderer extends ViewGroup implements IGCUserPeer {
    ...
    public PlatformRenderer(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        if (getClass() == PlatformRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.PlatformRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
