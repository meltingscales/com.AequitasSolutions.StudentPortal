...
public class PageContainer extends ViewGroup implements IGCUserPeer {
    ...
    public PageContainer(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (getClass() == PageContainer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.PageContainer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
