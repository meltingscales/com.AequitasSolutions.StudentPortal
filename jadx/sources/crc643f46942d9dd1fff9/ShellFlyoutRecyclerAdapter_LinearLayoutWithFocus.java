...
public class ShellFlyoutRecyclerAdapter_LinearLayoutWithFocus extends LinearLayout implements IGCUserPeer {
    ...
    public ShellFlyoutRecyclerAdapter_LinearLayoutWithFocus(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        if (getClass() == ShellFlyoutRecyclerAdapter_LinearLayoutWithFocus.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.ShellFlyoutRecyclerAdapter+LinearLayoutWithFocus, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
