...
public class PathView extends ShapeView implements IGCUserPeer {
    ...
    public PathView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (getClass() == PathView.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.PathView, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
