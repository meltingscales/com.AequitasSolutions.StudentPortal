...
public class BorderDrawable extends Drawable implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.BorderDrawable, Xamarin.Forms.Platform.Android", BorderDrawable.class, "n_isStateful:()Z:GetIsStatefulHandler\nn_getOpacity:()I:GetGetOpacityHandler\nn_draw:(Landroid/graphics/Canvas;)V:GetDraw_Landroid_graphics_Canvas_Handler\nn_setAlpha:(I)V:GetSetAlpha_IHandler\nn_setColorFilter:(Landroid/graphics/ColorFilter;)V:GetSetColorFilter_Landroid_graphics_ColorFilter_Handler\nn_onStateChange:([I)Z:GetOnStateChange_arrayIHandler\n");
    }

    public BorderDrawable() {
        if (getClass() == BorderDrawable.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.BorderDrawable, Xamarin.Forms.Platform.Android", "", this, new Object[0]);
        }
    }
