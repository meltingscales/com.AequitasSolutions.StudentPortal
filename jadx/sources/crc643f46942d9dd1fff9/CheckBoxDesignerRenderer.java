...
public class CheckBoxDesignerRenderer extends CheckBox implements IGCUserPeer, View.OnFocusChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    public CheckBoxDesignerRenderer(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        if (getClass() == CheckBoxDesignerRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.CheckBoxDesignerRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
