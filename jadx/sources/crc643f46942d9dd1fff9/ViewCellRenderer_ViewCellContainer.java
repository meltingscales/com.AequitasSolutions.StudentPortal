...
public class ViewCellRenderer_ViewCellContainer extends ViewGroup implements IGCUserPeer {
    ...
    public ViewCellRenderer_ViewCellContainer(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (getClass() == ViewCellRenderer_ViewCellContainer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.ViewCellRenderer+ViewCellContainer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
