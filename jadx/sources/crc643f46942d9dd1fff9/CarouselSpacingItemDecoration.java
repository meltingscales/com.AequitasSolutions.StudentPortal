...
public class CarouselSpacingItemDecoration extends RecyclerView.ItemDecoration implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.CarouselSpacingItemDecoration, Xamarin.Forms.Platform.Android", CarouselSpacingItemDecoration.class, "n_getItemOffsets:(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$State;)V:GetGetItemOffsets_Landroid_graphics_Rect_Landroid_view_View_Landroidx_recyclerview_widget_RecyclerView_Landroidx_recyclerview_widget_RecyclerView_State_Handler\n");
    }

    public CarouselSpacingItemDecoration() {
        if (getClass() == CarouselSpacingItemDecoration.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.CarouselSpacingItemDecoration, Xamarin.Forms.Platform.Android", "", this, new Object[0]);
        }
    }
