...
public class GradientStrokeDrawable extends PaintDrawable implements IGCUserPeer {
    ...
    public GradientStrokeDrawable(int i) {
        super(i);
        if (getClass() == GradientStrokeDrawable.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.GradientStrokeDrawable, Xamarin.Forms.Platform.Android", "Android.Graphics.Color, Mono.Android", this, new Object[]{Integer.valueOf(i)});
        }
    }
