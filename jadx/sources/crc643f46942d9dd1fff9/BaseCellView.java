...
public class BaseCellView extends LinearLayout implements IGCUserPeer {
    ...
    public BaseCellView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (getClass() == BaseCellView.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.BaseCellView, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
