...
public class PowerSaveModeBroadcastReceiver extends BroadcastReceiver implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.PowerSaveModeBroadcastReceiver, Xamarin.Forms.Platform.Android", PowerSaveModeBroadcastReceiver.class, "n_onReceive:(Landroid/content/Context;Landroid/content/Intent;)V:GetOnReceive_Landroid_content_Context_Landroid_content_Intent_Handler\n");
    }
