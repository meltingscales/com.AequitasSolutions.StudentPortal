...
public class ShellToolbarTracker implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.ShellToolbarTracker, Xamarin.Forms.Platform.Android", ShellToolbarTracker.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public ShellToolbarTracker() {
        if (getClass() == ShellToolbarTracker.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.ShellToolbarTracker, Xamarin.Forms.Platform.Android", "", this, new Object[0]);
        }
    }
