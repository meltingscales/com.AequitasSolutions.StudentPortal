...
public class WebAuthenticatorActivity extends AccountAuthenticatorActivity implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Auth.WebAuthenticatorActivity, Xamarin.Auth", WebAuthenticatorActivity.class, "n_onCreate:(Landroid/os/Bundle;)V:GetOnCreate_Landroid_os_Bundle_Handler\nn_onResume:()V:GetOnResumeHandler\nn_onBackPressed:()V:GetOnBackPressedHandler\nn_onRetainNonConfigurationInstance:()Ljava/lang/Object;:GetOnRetainNonConfigurationInstanceHandler\nn_onSaveInstanceState:(Landroid/os/Bundle;)V:GetOnSaveInstanceState_Landroid_os_Bundle_Handler\n");
    }

    public WebAuthenticatorActivity() {
        if (getClass() == WebAuthenticatorActivity.class) {
            TypeManager.Activate("Xamarin.Auth.WebAuthenticatorActivity, Xamarin.Auth", "", this, new Object[0]);
        }
    }
