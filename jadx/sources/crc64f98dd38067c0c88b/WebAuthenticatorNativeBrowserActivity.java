...
public class WebAuthenticatorNativeBrowserActivity extends AccountAuthenticatorActivity implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Auth.WebAuthenticatorNativeBrowserActivity, Xamarin.Auth", WebAuthenticatorNativeBrowserActivity.class, __md_methods);
    }

    public WebAuthenticatorNativeBrowserActivity() {
        if (getClass() == WebAuthenticatorNativeBrowserActivity.class) {
            TypeManager.Activate("Xamarin.Auth.WebAuthenticatorNativeBrowserActivity, Xamarin.Auth", "", this, new Object[0]);
        }
    }
