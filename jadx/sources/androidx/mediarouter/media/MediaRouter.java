    ...
    public static final class PrepareTransferNotifier {
        ...
        void setFuture(ListenableFuture<Void> listenableFuture) {
            ...
            if (globalMediaRouter == null || globalMediaRouter.mTransferNotifier != this) {
                ...
                Runnable runnable = new Runnable() { // from class: androidx.mediarouter.media.-$$Lambda$Imllk-kvB0ZHEw1qUNyltfgdrRI
                    @Override // java.lang.Runnable
                    public final void run() {
                ...
                listenableFuture.addListener(runnable, new Executor() { // from class: androidx.mediarouter.media.-$$Lambda$NDO7Qw6A9VIRO38DQMrkJ7t8FzE
