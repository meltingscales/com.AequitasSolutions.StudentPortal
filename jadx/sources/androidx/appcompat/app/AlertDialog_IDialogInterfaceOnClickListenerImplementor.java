...
public class AlertDialog_IDialogInterfaceOnClickListenerImplementor implements IGCUserPeer, DialogInterface.OnClickListener {
    ...
    static {
        Runtime.register("AndroidX.AppCompat.App.AlertDialog+IDialogInterfaceOnClickListenerImplementor, Xamarin.AndroidX.AppCompat", AlertDialog_IDialogInterfaceOnClickListenerImplementor.class, "n_onClick:(Landroid/content/DialogInterface;I)V:GetOnClick_Landroid_content_DialogInterface_IHandler:Android.Content.IDialogInterfaceOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }
    ...
    public AlertDialog_IDialogInterfaceOnClickListenerImplementor() {
        if (getClass() == AlertDialog_IDialogInterfaceOnClickListenerImplementor.class) {
            TypeManager.Activate("AndroidX.AppCompat.App.AlertDialog+IDialogInterfaceOnClickListenerImplementor, Xamarin.AndroidX.AppCompat", "", this, new Object[0]);
        }
    }
