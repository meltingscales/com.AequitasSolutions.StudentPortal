...
public class BarometerListener implements IGCUserPeer, SensorEventListener {
    ...
    static {
        Runtime.register("Xamarin.Essentials.BarometerListener, Xamarin.Essentials", BarometerListener.class, "n_onAccuracyChanged:(Landroid/hardware/Sensor;I)V:GetOnAccuracyChanged_Landroid_hardware_Sensor_IHandler:Android.Hardware.ISensorEventListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\nn_onSensorChanged:(Landroid/hardware/SensorEvent;)V:GetOnSensorChanged_Landroid_hardware_SensorEvent_Handler:Android.Hardware.ISensorEventListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public BarometerListener() {
        if (getClass() == BarometerListener.class) {
            TypeManager.Activate("Xamarin.Essentials.BarometerListener, Xamarin.Essentials", "", this, new Object[0]);
        }
    }
