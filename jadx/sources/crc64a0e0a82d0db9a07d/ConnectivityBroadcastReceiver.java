...
public class ConnectivityBroadcastReceiver extends BroadcastReceiver implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Essentials.ConnectivityBroadcastReceiver, Xamarin.Essentials", ConnectivityBroadcastReceiver.class, "n_onReceive:(Landroid/content/Context;Landroid/content/Intent;)V:GetOnReceive_Landroid_content_Context_Landroid_content_Intent_Handler\n");
    }

    public ConnectivityBroadcastReceiver() {
        if (getClass() == ConnectivityBroadcastReceiver.class) {
            TypeManager.Activate("Xamarin.Essentials.ConnectivityBroadcastReceiver, Xamarin.Essentials", "", this, new Object[0]);
        }
    }
