...
public class AccelerometerListener implements IGCUserPeer, SensorEventListener {
    ...
    static {
        Runtime.register("Xamarin.Essentials.AccelerometerListener, Xamarin.Essentials", AccelerometerListener.class, "n_onAccuracyChanged:(Landroid/hardware/Sensor;I)V:GetOnAccuracyChanged_Landroid_hardware_Sensor_IHandler:Android.Hardware.ISensorEventListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\nn_onSensorChanged:(Landroid/hardware/SensorEvent;)V:GetOnSensorChanged_Landroid_hardware_SensorEvent_Handler:Android.Hardware.ISensorEventListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public AccelerometerListener() {
        if (getClass() == AccelerometerListener.class) {
            TypeManager.Activate("Xamarin.Essentials.AccelerometerListener, Xamarin.Essentials", "", this, new Object[0]);
        }
    }
