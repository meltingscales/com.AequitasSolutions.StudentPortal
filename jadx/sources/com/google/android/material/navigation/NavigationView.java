...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainTintedStyledAttributes.hasValue(R.styleable.NavigationView_elevation)) {
            ViewCompat.setElevation(this, obtainTintedStyledAttributes.getDimensionPixelSize(i2, 0));
        }
        ...
        if (obtainTintedStyledAttributes.hasValue(i4)) {
            createDefaultColorStateList = obtainTintedStyledAttributes.getColorStateList(i4);
        } else {
