...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (i >= 21) {
            int i3 = R.styleable.AppBarLayout_elevation;
            if (obtainStyledAttributes.hasValue(i3)) {
                ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, obtainStyledAttributes.getDimensionPixelSize(i3, 0));
            }
        }
        if (i >= 26) {
