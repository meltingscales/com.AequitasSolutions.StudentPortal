...
public final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        ...
        Migration lambdaFactory$ = SchemaManager$$Lambda$2.lambdaFactory$();
        MIGRATE_TO_V2 = lambdaFactory$;
        Migration lambdaFactory$2 = SchemaManager$$Lambda$3.lambdaFactory$();
        MIGRATE_TO_V3 = lambdaFactory$2;
        Migration lambdaFactory$3 = SchemaManager$$Lambda$4.lambdaFactory$();
        MIGRATE_TO_V4 = lambdaFactory$3;
        INCREMENTAL_MIGRATIONS = Arrays.asList(migration, lambdaFactory$, lambdaFactory$2, lambdaFactory$3);
    }
