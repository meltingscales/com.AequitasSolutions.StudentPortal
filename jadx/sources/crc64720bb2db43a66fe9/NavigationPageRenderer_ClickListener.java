...
public class NavigationPageRenderer_ClickListener implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.AppCompat.NavigationPageRenderer+ClickListener, Xamarin.Forms.Platform.Android", NavigationPageRenderer_ClickListener.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public NavigationPageRenderer_ClickListener() {
        if (getClass() == NavigationPageRenderer_ClickListener.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.AppCompat.NavigationPageRenderer+ClickListener, Xamarin.Forms.Platform.Android", "", this, new Object[0]);
        }
    }
