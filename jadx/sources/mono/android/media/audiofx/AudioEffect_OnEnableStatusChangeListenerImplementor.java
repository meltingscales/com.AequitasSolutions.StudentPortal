...
public class AudioEffect_OnEnableStatusChangeListenerImplementor implements IGCUserPeer, AudioEffect.OnEnableStatusChangeListener {
    ...
    static {
        Runtime.register("Android.Media.Audiofx.AudioEffect+IOnEnableStatusChangeListenerImplementor, Mono.Android", AudioEffect_OnEnableStatusChangeListenerImplementor.class, __md_methods);
    }
