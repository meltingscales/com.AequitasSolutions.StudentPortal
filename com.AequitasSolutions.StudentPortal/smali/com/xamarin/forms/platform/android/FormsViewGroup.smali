...
.method public measureAndLayout(IIIIII)V
    ...
    .line 37
    invoke-virtual {p0, p3, p4, p5, p6}, Landroid/view/ViewGroup;->layout(IIII)V
...
.method public sendBatchUpdate(FFIZFFFFFFFF)V
    ...
    .line 88
    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setPivotY(F)V
    ...
    .line 94
    invoke-virtual {p0, p4}, Landroid/view/ViewGroup;->setEnabled(Z)V
    ...
    .line 97
    invoke-virtual {p0, p6}, Landroid/view/ViewGroup;->setRotation(F)V

    .line 98
    invoke-virtual {p0, p7}, Landroid/view/ViewGroup;->setRotationX(F)V

    .line 99
    invoke-virtual {p0, p8}, Landroid/view/ViewGroup;->setRotationY(F)V

    .line 100
    invoke-virtual {p0, p9}, Landroid/view/ViewGroup;->setScaleX(F)V

    .line 101
    invoke-virtual {p0, p10}, Landroid/view/ViewGroup;->setScaleY(F)V

    .line 102
    invoke-virtual {p0, p11}, Landroid/view/ViewGroup;->setTranslationX(F)V

    .line 103
    invoke-virtual {p0, p12}, Landroid/view/ViewGroup;->setTranslationY(F)V
