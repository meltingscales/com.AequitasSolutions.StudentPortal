...
.method public final zaa()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/zaal;->zaa:Lcom/google/android/gms/common/api/internal/zaar;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/internal/zaal;->zac:Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/google/android/gms/common/api/internal/zaal;->zac:Ljava/util/Map;

    invoke-interface {v5, v4}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/google/android/gms/common/api/internal/zaai;

    invoke-static {v5}, Lcom/google/android/gms/common/api/internal/zaai;->zaa(Lcom/google/android/gms/common/api/internal/zaai;)Z
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/api/internal/zaal;->zaa:Lcom/google/android/gms/common/api/internal/zaar;

    invoke-static {v4}, Lcom/google/android/gms/common/api/internal/zaar;->zai(Lcom/google/android/gms/common/api/internal/zaar;)Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/internal/zaal;->zaa:Lcom/google/android/gms/common/api/internal/zaar;

    .line 14
    invoke-direct {v2, p0, v3, v0}, Lcom/google/android/gms/common/api/internal/zaaj;-><init>(Lcom/google/android/gms/common/api/internal/zaal;Lcom/google/android/gms/common/api/internal/zaba;Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/api/internal/zaar;->zan(Lcom/google/android/gms/common/api/internal/zaar;)Z
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/api/internal/zaar;->zao(Lcom/google/android/gms/common/api/internal/zaar;)Lcom/google/android/gms/signin/zae;
    ...
    .line 15
    invoke-interface {v1}, Lcom/google/android/gms/signin/zae;->zad()V

    :cond_7
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/zaal;->zac:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/zaal;->zaa:Lcom/google/android/gms/common/api/internal/zaar;
    ...
    iget-object v5, p0, Lcom/google/android/gms/common/api/internal/zaal;->zaa:Lcom/google/android/gms/common/api/internal/zaar;

    .line 21
    invoke-direct {v4, p0, v5, v3}, Lcom/google/android/gms/common/api/internal/zaak;-><init>(Lcom/google/android/gms/common/api/internal/zaal;Lcom/google/android/gms/common/api/internal/zaba;Lcom/google/android/gms/common/internal/BaseGmsClient$ConnectionProgressReportCallbacks;)V

    invoke-virtual {v2, v4}, Lcom/google/android/gms/common/api/internal/zabd;->zar(Lcom/google/android/gms/common/api/internal/zabb;)V
